...
const About: AboutComponent = () => {
  return (
    <>
      <h1>Who am I?</h1>
      <p>
        I was born on [REDACTED] in [REDACTED], I&apos;m currently 18 years old
        and living in Poznan, Poland. At this point in time I have only primary
        education and finished more than half of my High School. I have the
        CISCO ITE 5.0 certificate and I&apos;m undergoing the CISCO CCNA1
