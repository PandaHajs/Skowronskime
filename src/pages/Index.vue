  ...
  <Layout>
    ...
    <div class="box">
      ...
      <p class="p1">
        ...
        A 17 year old IT Student from Poland with the life motto “If I don't
        have to do it, I won't. If I have to do it, I'll make it quick.”, who
        for some reason made this site without having to
      </p>
    </div>
    <div id="box3">
